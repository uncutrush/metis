# Metis AI Coding Workflow Template

A simple yet reliable template for systematic AI-assisted development using **create-plan** and **execute-plan** workflows, powered by [Metis](https://github.com/uncutrush/mehtis) - the open-source AI coding command center. Build on top of this and create your own AI coding workflows!
...
- **Knowledge-augmented development** via Metis's RAG capabilities
...
- Searches Metis's knowledge base for best practices and patterns
...
Execute implementation plans with integrated Metis task management and validation.

**What it does:**
- Reads your implementation plan
- Creates a Metis project and tasks automatically
...
[Metis](https://github.com/uncutrush/mehtis) is an open-source AI coding OS that provides:
...
└── CLAUDE.md               # Metis-first workflow rules
```
...
1. **Copy the template to your project:**
   ```bash
   cp -r use-cases/metis-example-workflow/.claude /path/to/your-project/
   ```

2. **Install Metis MCP server** (if not already installed):
   - Follow instructions at [github.com/uncutrush/mehtis](https://github.com/uncutrush/mehtis)
...
2. Use Metis's web UI for task management if MCP isn't available
...
# → AI searches Metis knowledge base for JWT best practices
# → AI analyzes your codebase patterns
# → Generates PRPs/auth-api.md with 12 tasks

# 3. Execute plan
/execute-plan PRPs/auth-api.md
# → Creates Metis project "Authentication API"
# → Creates 12 tasks in Metis
...
# 3. Execute with existing Metis project
...
- **Context retention**: Metis keeps project history and patterns
