...
If Metis RAG is available and relevant:
- Use `mcp__metis__rag_get_available_sources()` to see available documentation
- Search for relevant patterns: `mcp__metis__rag_search_knowledge_base(query="...")`
- Find code examples: `mcp__metis__rag_search_code_examples(query="...")`
