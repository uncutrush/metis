...
This document describes the actual naming conventions used throughout Metis's codebase based on current implementation patterns. All examples reference real files where these patterns are implemented.
...
**Reference**: `metis-ui-main/src/features/projects/services/projectService.ts`
...
- **Projects**: `metis-ui-main/src/features/projects/services/projectService.ts`
- **Tasks**: `metis-ui-main/src/features/projects/tasks/services/taskService.ts`
- **Knowledge**: `metis-ui-main/src/features/knowledge/services/knowledgeService.ts`
- **Progress**: `metis-ui-main/src/features/progress/services/progressService.ts`

## React Hook Naming

### Query Hooks
**Reference**: `metis-ui-main/src/features/projects/tasks/hooks/useTaskQueries.ts`
...
### Utility Hooks
**Reference**: `metis-ui-main/src/features/ui/hooks/`
...
**Reference**: `metis-ui-main/src/features/projects/types/`
...
**Location**: `metis-ui-main/src/features/projects/tasks/types/task.ts`
...
### Page Components
**Location**: `metis-ui-main/src/pages/`
- `[Feature]Page.tsx` - Top-level pages
- `[Feature]View.tsx` - Main view components

### Feature Components
**Location**: `metis-ui-main/src/features/{feature}/components/`
...
### Shared Components
**Location**: `metis-ui-main/src/features/ui/primitives/`
...
### Loading States
**Examples from**: `metis-ui-main/src/features/projects/views/ProjectsView.tsx`
