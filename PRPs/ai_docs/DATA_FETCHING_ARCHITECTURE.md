...
Metis uses **TanStack Query v5** for all data fetching, caching, and synchronization. This replaces the former custom polling layer with a query‑centric design that handles caching, deduplication, and smart refetching (including visibility‑aware polling) automatically.

## Core Components

### 1. Query Client Configuration

**Location**: `metis-ui-main/src/features/shared/config/queryClient.ts`
...
**Location**: `metis-ui-main/src/features/ui/hooks/useSmartPolling.ts`
...
**Location**: `metis-ui-main/src/features/shared/config/queryPatterns.ts`
...
- **Projects**: `metis-ui-main/src/features/projects/hooks/useProjectQueries.ts` (projectKeys)
- **Tasks**: `metis-ui-main/src/features/projects/tasks/hooks/useTaskQueries.ts` (taskKeys)
- **Knowledge**: `metis-ui-main/src/features/knowledge/hooks/useKnowledgeQueries.ts` (knowledgeKeys)
- **Progress**: `metis-ui-main/src/features/progress/hooks/useProgressQueries.ts` (progressKeys)
- **MCP**: `metis-ui-main/src/features/mcp/hooks/useMcpQueries.ts` (mcpKeys)
- **Documents**: `metis-ui-main/src/features/projects/documents/hooks/useDocumentQueries.ts` (documentKeys)
...
**Location**: `metis-ui-main/src/features/shared/api/apiClient.ts`
...
**Utilities**: `metis-ui-main/src/features/shared/utils/optimistic.ts`
...
**Implementation**: `metis-ui-main/src/features/ui/hooks/useSmartPolling.ts`

Polling intervals are defined in each feature's query hooks. See actual implementations:
- **Projects**: `metis-ui-main/src/features/projects/hooks/useProjectQueries.ts`
- **Tasks**: `metis-ui-main/src/features/projects/tasks/hooks/useTaskQueries.ts`
- **Knowledge**: `metis-ui-main/src/features/knowledge/hooks/useKnowledgeQueries.ts`
- **Progress**: `metis-ui-main/src/features/progress/hooks/useProgressQueries.ts`
- **MCP**: `metis-ui-main/src/features/mcp/hooks/useMcpQueries.ts`

Standard intervals from `metis-ui-main/src/features/shared/config/queryPatterns.ts`:
...
**Example**: `metis-ui-main/src/features/projects/hooks/tests/useProjectQueries.test.ts`
