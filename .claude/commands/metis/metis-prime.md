...
name: prime
description: |
  Prime Claude Code with deep context for a specific part of the Metis codebase.
...
You're about to work on the Metis V2 Beta codebase. This is a microservices-based knowledge management system with MCP integration. Here's what you need to know:
...
- `metis-ui-main/src/App.tsx` - Main app structure and routing
- `metis-ui-main/src/services/knowledgeBaseService.ts` - API call patterns
- `metis-ui-main/src/services/socketIOService.ts` - Real-time events
...
- `metis-ui-main/src/components/project-tasks/TaskBoardView.tsx` - Kanban UI
