---
name: prime-simple
description: Quick context priming for Metis development - reads essential files and provides project overview
argument-hint: none
---

## Prime Context for Metis Development

You need to quickly understand the Metis V2 Beta codebase. Follow these steps:
...
- `metis-ui-main/` - Frontend React application
...
Read these essential files in `metis-ui-main/`:
...
1. **Project Purpose**: One sentence about what Metis does and why it exists
