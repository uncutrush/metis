---
description: Generate Root Cause Analysis report for Metis V2 Beta issues
argument-hint: <issue description or error message>
allowed-tools: Bash(*), Read, Grep, LS, Write
thinking: auto
---

# Root Cause Analysis for Metis V2 Beta
...
You're working with Metis V2 Beta, a microservices-based AI knowledge management system:
...
- `metis-ui-main/src/main.tsx` - Frontend
...
- `metis-ui-main/src/services/` - Frontend API calls
...
# Database test
docker-compose exec metis-server python -c "from src.server.services.supabase_service import SupabaseService; print(SupabaseService.health_check())"
