...
description: |
  Onboard new developers to the Metis codebase with a comprehensive overview and first contribution guidance.

  Usage: /metis-onboarding
argument-hint: none
---

You are helping a new developer get up and running with the Metis V2 Beta project! Your goal is to provide them with a personalized onboarding experience.

## What is Metis?

Metis is a centralized knowledge base for AI coding assistants. It enables Claude Code, Cursor, Windsurf, and other AI tools to access your documentation, perform smart searches, and manage tasks - all through a unified interface.
...
"Which area of the Metis codebase would you like to explore first?"
...
- Start with `metis-ui-main/src/pages/KnowledgeBasePage.tsx`
