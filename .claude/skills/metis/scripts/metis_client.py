#!/usr/bin/env python3
"""
Metis API Client - Standardized interface for Metis REST API
...
class MetisClient:
    """Client for interacting with Metis API Server"""
    
    def __init__(self, base_url: str = "http://localhost:8181"):
        """Initialize Metis client
        
        Args:
            base_url: Base URL for Metis API Server (default: http://localhost:8181)
        """
