...
Complete reference for all Metis REST API endpoints. This mirrors the functionality of the 14 MCP tools.

## Base Configuration

**API Server:** `http://localhost:8181` (configurable via `METIS_SERVER_PORT`)
