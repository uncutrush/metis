...
Sitemap: https://example.com/sitemap-news.xml"""
        ...
        mock_get.assert_called_once_with("https://example.com/robots.txt", timeout=30, stream=True, verify=True, headers={'User-Agent': 'Metis-Discovery/1.0 (SSRF-Protected)'})
...
Allow: /public/"""
    ...
    def test_parse_html_meta_tags(self, mock_get, mock_session, mock_dns):
        ...
        mock_get.assert_called_once_with("https://example.com", timeout=30, stream=True, verify=True, headers={'User-Agent': 'Metis-Discovery/1.0 (SSRF-Protected)'})
