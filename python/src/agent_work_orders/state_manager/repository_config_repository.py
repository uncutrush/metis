...
class RepositoryConfigRepository:
    ...
    Provides CRUD operations for the metis_configured_repositories table.
    Uses the same Supabase client as the main Metis server for consistency.
    ...
    def __init__(self) -> None:
        ...
        self.table_name: str = "metis_configured_repositories"
