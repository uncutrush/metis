...
Reuses same Supabase credentials as main Metis server (SUPABASE_URL, SUPABASE_SERVICE_KEY).
"""
...
def get_agent_work_orders_client() -> Client:
    ...
    Reuses same credentials as main Metis server (SUPABASE_URL, SUPABASE_SERVICE_KEY).
    ...
    if not url or not key:
        raise ValueError(
            ...
            "These should match the credentials used by the main Metis server."
        )
