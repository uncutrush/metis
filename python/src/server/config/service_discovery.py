...
class ServiceDiscovery:
    ...
    SERVICE_NAMES = {
        ...
        "mcp": "metis-mcp",
        "agents": "metis-agents",
        "agent_work_orders": "metis-agent-work-orders",
        "metis-server": "metis-server",
        "metis-mcp": "metis-mcp",
        "metis-agents": "metis-agents",
        "metis-agent-work-orders": "metis-agent-work-orders",
    }
    ...
    def get_all_services(self) -> dict[str, str]:
        ...
        return {
            ...
            if not service.startswith("metis-")  # Skip duplicates
        }
