...
from ..config.version import METIS_VERSION, GITHUB_REPO_NAME, GITHUB_REPO_OWNER
...
class VersionService:
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                response = await client.get(
                    ...
                    headers={
                        ...
                        "User-Agent": f"Metis/{METIS_VERSION}",
                    },
                )
    ...
    async def check_for_updates(self) -> dict[str, Any]:
        ...
        try:
            ...
            update_available = is_newer_version(METIS_VERSION, latest_version)
