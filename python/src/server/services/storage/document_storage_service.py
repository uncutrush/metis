    ...
    with safe_span(
        ...
        try:
            if unique_urls:
                ...
                for i in range(0, len(unique_urls), delete_batch_size):
                    ...
                    client.table("metis_crawled_pages").delete().in_("url", batch_urls).execute()
        ...
        for batch_num, i in enumerate(range(0, len(contents), batch_size), 1):
            ...
            for retry in range(max_retries):
                ...
                try:
                    client.table("metis_crawled_pages").insert(batch_data).execute()
                    ...
                    if retry < max_retries - 1:
                        ...
                        for record in batch_data:
                            ...
                            try:
                                client.table("metis_crawled_pages").insert(record).execute()
