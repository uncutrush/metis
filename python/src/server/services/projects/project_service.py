...
class ProjectService:
    ...
    def create_project(self, title: str, github_repo: str = None) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            ...
            # Insert project
            response = self.supabase_client.table("metis_projects").insert(project_data).execute()
    ...
    def list_projects(self, include_content: bool = True) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            if include_content:
                ...
                response = (
                    self.supabase_client.table("metis_projects")
                    .select("*")
        ...
        try:
            ...
            if response.data:
                ...
                try:
                    ...
                    sources_response = (
                        self.supabase_client.table("metis_project_sources")
