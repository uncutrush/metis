...
class TaskService:
        ...
        try:
            ...
            if task_order > 0:
                ...
                existing_tasks_response = (
                    self.supabase_client.table("metis_tasks")
                ...
                if existing_tasks_response.data:
                    ...
                    for existing_task in existing_tasks_response.data:
                        ...
                        self.supabase_client.table("metis_tasks").update({
            ...
            response = self.supabase_client.table("metis_tasks").insert(task_data).execute()
    ...
    def list_tasks(
        ...
        try:
            ...
            if exclude_large_fields:
                ...
                query = self.supabase_client.table("metis_tasks").select(
    ...
    def get_task(self, task_id: str) -> tuple[bool, dict[str, Any]]:
        ...
        try:
            response = (
                self.supabase_client.table("metis_tasks").select("*").eq("id", task_id).execute()
            )
